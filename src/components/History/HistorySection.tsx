  ...
  return (
    ...
    >
      ...
      <motion.ul
        ...
        className={twMerge(
          "flex flex-col gap-2 bg-white rounded-md shadow-md p-2 w-full mb-3"
        )}
      ...
      >
        ...
        {recipes.length > 0 &&
          recipes.map((recipe) => (
            ...
            >
              <p className="text-center bg-white rounded-md w-6 h-6">
                {emojies[Math.floor(Math.random() * emojies.length)]}
              </p>
              <p className="text-base text-center text-gray-600 font-semibold mx-2">
                {recipe.foodName}
              </p>
            </motion.li>
          ))}
